...
/// An ODPS document as it arrives — raw text, plus the name diagnostics about
/// it should carry.
///
...
///
/// ```
/// use conform_odps::Document;
///
/// let document = Document::new("products/orders.yaml", "apiVersion: v1.0.0\n");
/// assert_eq!(document.id().as_str(), "products/orders.yaml");
/// ```
