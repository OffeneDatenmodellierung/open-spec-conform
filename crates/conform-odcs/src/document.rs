...
/// An ODCS document as it arrives — raw text, plus the name diagnostics about
/// it should carry.
///
...
///
/// ```
/// use conform_odcs::Document;
///
/// let document = Document::new("contracts/orders.yaml", "apiVersion: v3.1.0\n");
